...
bool ChatHandler::HandleGMAnnounceCommand(const char* args, WorldSession* m_session)
{
	...
	snprintf(GMAnnounce, 1024, MSG_COLOR_RED "[GM CHAT]" MSG_COLOR_GREEN " |Hplayer:%s|h[%s]|h:" MSG_COLOR_YELLOW " %s", m_session->GetPlayer()->GetName(), m_session->GetPlayer()->GetName(), args);
